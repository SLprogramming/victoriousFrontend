    ...
    <div class="modal-dialog" style="max-width: 800px">
      <div class="modal-content" style="width: 800px">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="packageSaleVoucherModalLabel">Voucher Modal</h1>
        ...
        <div class="modal-footer">
          <button type="button" id="closeSaleVoucherModal" class="btn btn-secondary"
            data-bs-dismiss="modal">Close</button>
          <button type="button" @click="openPrintModal" class="btn btn-primary">Print</button>
        </div>
      </div>
    </div>
  </div>
...
const openPrintModal = () => {
  openPrint('packageSaleVoucherPrintCard', `table tr td:not(:first-child) {
  min-width: 80px;
}
